defmodule AppWeb.AuthLive.Index do
  ...
  defp apply_action(socket, :register, _params) do
    ...
    |> assign(
      :form,
      Form.for_create(User, :register_with_password, api: Account, as: "user")
    )
  end
  ...
  defp apply_action(socket, :sign_in, _params) do
    ...
    |> assign(
      :form,
      Form.for_action(User, :sign_in_with_password, api: Account, as: "user")
    )
  end
      ...
      <div class="container page">
        <div class="row">
          <div class="col-md-6 offset-md-3 col-xs-12">
            <h1 class="text-2xl font-bold"><%= @cta %></h1>
            <p class="text-sm">
              <a href={@alternative_path}><%= @alternative %></a>
            </p>

            <.live_component
              module={AppWeb.AuthLive.AuthForm}
              id={@form_id}
              form={@form}
